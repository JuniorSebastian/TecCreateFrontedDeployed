// src/components/Hero.jsx - VERSIÓN PREMIUM TECSUP
...
const Hero = () => {
  ...
  // Colores TECSUP reales: Celeste brillante + Azul claro + Blanco
  const stats = [
    { 
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-sky-50 via-cyan-50 to-blue-100">
      {/* Background con overlay celeste brillante */}
